...
\Comment{TODO(David)a graphic here would be nice}
\Comment{Nitpicky thing - David, if we want to stick with wording as above, would it be okay to redo blocking figure and have the whole group without numbers, then have each block numbered separately, in random order, then have the first however many numbers be in treatment and the remaining in control?   
}
