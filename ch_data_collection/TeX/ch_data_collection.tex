...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{ch_data_collection/figures/county_fed_spendVsPoverty/county_fed_spendVsPoverty}
...
\begin{figure}
   \centering
   \includegraphics[width=0.8\textwidth]{ch_data_collection/figures/multiunitsVsOwnership/multiunitsVsOwnership}
...
\begin{figure}
\centering
\hspace{8mm}\includegraphics[width=55mm]{ch_data_collection/figures/mnWinter/mnWinter}\hspace{4mm}
...
\begin{center}
\includegraphics[height=1.0in]{ch_data_collection/figures/variables/sunCausesCancer}
\end{center}
% Some studies:
...
\Comment{I think these two sentences that were previously omitted below are necessary for students to explicity tie it all together}
Sun exposure is a confounding factor because it is associated with both the use of sunscreen and the development of skin cancer. People who are out in the sun all day are more likely to use sunscreen, and people who are out in the sun all day are more likely to get skin cancer. Research shows us the the development of skin cancer is due to the sun exposure. The variables of sunscreen usage and sun exposure are \term{confounded} \Add{and without this research, we would have no way of knowing which one was the true cause of skin cancer.}
...
No, because there is no known association between being female and being more likely to get skin cancer. Thus, the fact that women are more likely (in this scenario) to wear sunblock is not a confounder, because it is only associated with the explanatory variable and not with the response variable. \Add{It does not explain the observed, existing association between sunblock usage and skin cancer.}
\end{example}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{ch_data_collection/figures/samplingMethodsFigure/simple_systematic}
...
Answers can vary. If we take a sample of size 3, then it is possible that we could sample players numbered 1, 2, and 3 in a simple random sample. Such a sample would be impossible from a systematic sample. \Add{Property 2 of simple random samples does not hold for other types of random samples.}
\end{example}

\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{ch_data_collection/figures/samplingMethodsFigure/stratified_cluster_multistage}
...
While it might be ideal for the subjects to be a random sample of the population of interest, that is rarely the case. Subjects must volunteer to be part of an experiment. However, because randomization is incorporated in the splitting of the groups, we can still use statistical techniques to check for a causal connection, though the precise population for which the conclusion applies may be unclear. \Comment{Without a contextual example like the one that follows, the previous sentence will not make any sense to students}. \Add{For example, if an experiment to determine the most effective means to encourage individuals to vote is carried out only on college students, we may not be able to generalize the conclusions of the experiment to all adults in the population.}
