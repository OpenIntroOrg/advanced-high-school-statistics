...
\item When taking a sample from a population, avoid \termsub{convenience samples}{convenience sample} and \termsub{volunteer samples}{volunteer sample}.  Instead, use a \term{random} sampling method.
