...
\section[Case study]{Case study: using stents to prevent strokes \sectionvideohref{https://www.youtube.com/watch?v=nEHFF1ADpWE}}
...
\Comment{TODO(Leah) - Add example about confounding variables with an explanation that describes what is required to explain a variable is a confounding variable.}
