...
Sampling randomly resolves the problem of selection bias. The most basic random sample is called a \term{simple random sample}, and it is the equivalent of using a raffle to select cases. This means that each case in the population has an equal chance of being included and there is no implied connection between the cases in the sample.  \Comment{D: This new sentence is repeating the topic sentence but in more words. I also think what it states is already clear after reading the rest of this paragraph. I think it should be cut. - L - agree.}
...
\end{enumerate}
\Comment{D: Property 1 is a corollary of Property 2. L - are you saying we should say this?}
