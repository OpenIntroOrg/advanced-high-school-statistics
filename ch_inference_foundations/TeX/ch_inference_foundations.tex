...
When examining a a proportion, we interpret the \term{p-value}\index{hypothesis testing!p-value|textbf} according to the nature of the alternative hypothesis.
\begin{description}
...
\Comment{D: Thoughts on changing ``test statistic'' in the formula in the term box below to be Z?

L: what about the case of t?

D: that isn't being discussed for 2 more chapters, and when it is, the reason why we use a different label `T' is provided. Using Z also should help tie students' minds back to the concepts within the normal distribution content.}
...
\Comment{D: Nice catch on noticing this omission!}
...
\Comment{Cut the example related to p-value for a court. Suggesting numbers in the legal setting is difficult since really needs to then also discuss some more complex topics, e.g. Prosecutor's Fallacy.}
