...
\section[Estimating unknown parameters]{Estimating unknown parameters \sectionvideohref{youtube-DNIauUrRIEM&list=PLkIselvEzpM7Pjo94m1e7J5jkIZkbQAl4}}
...
\section[Introducing hypothesis testing]{Introducing hypothesis testing \sectionvideohref{youtube-NVbPE1_Cbx8&list=PLkIselvEzpM7Pjo94m1e7J5jkIZkbQAl4}}
...
\Comment{D - This cannot be visualized properly by shading both tails since the distribution is not symmetric, so I'm not sure a picture should appear here. Thoughts?}
