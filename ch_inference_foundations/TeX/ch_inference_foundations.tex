...
\begin{termBox}{\tBoxTitle[]{(AP exam tip) When carrying out a confidence interval procedure, follow these five steps:}
\begin{itemize}
...
\begin{termBox}{\tBoxTitle[]{(AP exam tip) When carrying out a hypothesis test procedure, follow these five steps:}
\begin{itemize}
\setlength{\itemsep}{0mm}
