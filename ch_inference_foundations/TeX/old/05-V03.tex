...
\end{termBox}
When considering the case of the point estimate $\bar{x}$, there is one problem: there is no obvious way to estimate its standard deviation from a single sample. However, statistical theory provides a helpful tool to address this issue. 
...
\subsection{Normal approximation for the distribution of $\bar{x}$}

do some example probs.
