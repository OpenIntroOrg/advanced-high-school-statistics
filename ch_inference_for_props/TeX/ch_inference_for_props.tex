...
\begin{examplewrap}
\begin{nexample}{A February 2018 Marist Poll reports:
    ...
    than half of all U.S. adults think there is intelligent life on
    other planets?
...
%%
\subsection{Technology: the 1-proportion Z-interval}
...
\begin{figure}[h]
\centering
\Figure[A standard normal distribution is shown, with the area to the right of 0.89 shaded.  The shaded area appears to be about 20\% of the area under the curve.]
...
\begin{examplewrap}
\begin{nexample}{A Gallup poll conducted in March of 2016 found that 54\%
    of respondents oppose nuclear energy.
    This was the first time since Gallup first asked the question in 1994
    that a majority of respondents said they oppose nuclear energy.
    The survey was based on telephone interviews from a random sample of
    1,019 adults in the United States.
    Does this poll provide evidence that greater than half of U.S. adults
...
%%
\subsection{Technology: the 1-proportion Z-test}
...
%%
\subsection{Technology: the 2-proportion Z-interval}
\label{2propZint}
...
whether the way a question is phrased can influence a person's response. Pew Research Center conducted a survey with the following question:
\begin{quote}
...
%%
\subsection{Technology: the 2-proportion Z-test}
\label{2propZtest}
...
{0.7}{googleHTForDiffAlgPerformancePValue}
...
\begin{nexercise}
The table from
Figure~\ref{pewResearchPollOnApprovalRatingsForChiSquareSectionExampleAndExercises}
is reproduced below.
Use a calculator to find the expected values and the $\chi^2$-statistic, $df$,
and p-value for the chi-square test for independence.\footnotemark
