...
\begin{itemize}
\item[] To carry out a test on a single proportion we use a \term{1-proportion Z-test}.
\end{itemize}
...
\begin{itemize}
\item[] To carry out a test on a single proportion we choose the \term{2-proportion Z-interval}.
\end{itemize}
...
\end{itemize}
 \inferencestep{Choose} Choose the correct test procedure and identify it by name.\vspace{-1mm}
\begin{itemize}
\item[] To carry out a test for the difference of proportions we use a \term{2-proportion Z-test}.  
\end{itemize}
...
\inferencestep{Choose} Choose the correct test procedure and identify it by name.\vspace{-1mm}
\begin{itemize}
\item[]  Here we use a \termsub{$\pmb{\chi^2}$ test of homogeneity}{chi-square test of homogeneity@$\chi^2$ test of homogeneity}.
\end{itemize}
\inferencestep{Check} Check that the test statistic follows a chi-square distribution.\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\inferencestep{Choose} Choose the correct test procedure and identify it by name.\vspace{-1mm}
\begin{itemize}
\item[]  Here we use a \termsub{$\pmb{\chi^2}$ test of independence}{chi-square test of independence@$\chi^2$ test of independence}.
\end{itemize}
\inferencestep{Check} Check that the test statistic follows a chi-square distribution.\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\item When categorical data are arranged in a two way table, use the $\chi^2$ test of homogeneity or the $\chi^2$ test of independence.  These tests are almost identical;  the differences lie in the data collection method and in the hypotheses.
