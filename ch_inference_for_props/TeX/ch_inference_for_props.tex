...
\begin{example}{A poll randomly selected 1,042 adults residing in the state of New York and asked the question, ``Regardless of whether the person shows symptoms or not, do you support or oppose a 21 day quarantine for anyone who has come in contact with someone with the Ebola virus?"\footnote{\oiRedirect{ebola_quarantine_poll_2014}{NBC 4 New York / The Wall Street Journal / Marist Poll. October 31, 2014.}} Among the sample, 82\% said``support", 15\% said ``oppose", and 3\% said ``unsure". Carry out the appropriate confidence interval procedure for the proportion of adults in New York who supported a quarantine.}
\Comment{Still must add solution.}
\end{example}
...
\begin{termBox}{\tBoxTitle{\videohref{ti84_1_prop_CI} TI calculator: calculating the 1-proportion Z confidence interval}
...
\begin{termBox}{\tBoxTitle{\videohref{ti84_1_prop_HT} TI calculator: carrying out the 1-proportion Z test}
...
\Comment{Leah: did we ever define margin of error?

David: Not certain. Want to add a term box here?}
...
For a 95\% confidence level, the value $z^{\star}$ corresponds to 1.96. \Add{The margin of error is the part that follows the +/- in the confidence interval. It is half the total width of the confidence interval. We want:}
\begin{align*}
ME \leq 0.04 \\
...
\begin{termBox}{\tBoxTitle{\videohref{ti84_2_prop_CI} TI calculator: Calculating the 2-proportion Z confidence interval}
...
\begin{termBox}{\tBoxTitle{\videohref{ti84_2_prop_HT} TI calculator: Carrying out the 2-proportion Z test}
...
\begin{termBox}{\tBoxTitle{\videohref{ti84_chisq_GOF_test} TI calculator: Carrying out the chi-square goodness of fit test\vspace{0.5mm}}
...
\begin{termBox}{\tBoxTitle[]{\videohref{ti84_chisq_2_way_test} TI calculator: Entering data into a two-way table}
\begin{enumerate}
\setlength{\itemsep}{0mm}
...
\begin{termBox}{\tBoxTitle{\videohref{ti84_chisq_2_way_test} TI Calculator: Chi-square test of homogeneity and independence}
