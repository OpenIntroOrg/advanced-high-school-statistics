...
\begin{itemize} 
\item[] the parameter, e.g. the true proportion of U.S. residents that are over age 65, and the confidence level, C\%, to be used.  
\end{itemize}
\inferencestep{Choose} \vspace{-1mm}
\begin{itemize}
\item[] \term{1-proportion Z-interval} 
\end{itemize}
...
\begin{termBox}{\tBoxTitle{Hypothesis testing for a proportion}
...
\begin{termBox}{\tBoxTitle{Constructing a confidence interval for the difference of two proportions}
To carry out a complete confidence interval procedure to estimate the difference of two proportions $p_1-p_2$,
\\
\\
 \inferencestep{Identify} \vspace{-1mm}
\begin{itemize}
\item[]  the parameter, e.g. the true difference in the proportion of 17 and 18 year olds with a summer job [prop. of 18 year olds $-$ prop. of 17 year olds], and the confidence level, C\%, to be used.  
\end{itemize} \vspace{-1mm}
\inferencestep{Choose} \vspace{-1mm}
\begin{itemize}
\item[] \term{2-proportion Z-interval} 
\end{itemize}
 \inferencestep{Check}\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\begin{tipBox}{\tipBoxTitle{Use the pooled proportion estimate when $\mathbf{H_0}$\textbf{:} $\mathbf{p_1 = p_2}$}
...
\begin{eqnarray*}
Z = \frac{\text{point estimate} - \text{null value}}{SE\ \text{of estimate}}= \frac{0.067 - 0}{0.026} = 2.58
\end{eqnarray*}
...
\begin{termBox}{\tBoxTitle{Hypothesis testing for the difference of two proportions}
...
\item[] $H_A$: The distribution of [...] doesn't match the specified or population
\item[] \quad \quad \ population distribution. 
\item[] and the significance level $\alpha$ to be used.
\end{itemize}
\inferencestep{Choose}\vspace{-1mm}
\begin{itemize}
\item[]  \term{$\mathbf{\chi^2}$ goodness of fit test}
\end{itemize}
\inferencestep{Check}\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\end{itemize}
\inferencestep{Calculate}\vspace{-1mm}  
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\begin{description}
\setlength{\itemsep}{0mm}
\item[Mutliple random samples or randomly assigned treatments. ]Data collected by multiple independent random samples or multiple randomlly assigned treatments. Data can then be organized into a two-way table.
...
The chi-square test of Independence proceeds exactly like the chi-square test of homogeneity, except that it applies when there is only one random sample (versus multiple random samples or an experiment with multiple randomly assigned treatments). The null claim is always that two variables are independent, while the alternate claim is that the variables are dependent.
...
\begin{termBox}{\tBoxTitle{$\chi^2$ test of homogeneity}
...
\inferencestep{Choose}\vspace{-1mm}
\begin{itemize}
\item[]  \term{$\mathbf{\chi^2}$ test of homogeneity}
\end{itemize}
\inferencestep{Check}\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\begin{termBox}{\tBoxTitle{$\chi^2$ test of independence}
...
\inferencestep{Choose}\vspace{-1mm}
\begin{itemize}
\item[]  \term{$\mathbf{\chi^2}$ test of independence}
\end{itemize}
\inferencestep{Check}\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
