...
Using Equation~\eqref{seOfDiffInPropUsingPooledEstimate}, $\hat{p}=0.342$, $n_1 = 491$, and $n_2=945$, verify the estimate for the standard error in the context of a hypothesis test is $SE = 0.026$.
\end{exercise}
