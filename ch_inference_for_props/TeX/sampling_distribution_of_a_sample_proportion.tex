...
\begin{center}
\includegraphics[width=0.85\textwidth]{ch_inference_for_props/figures/eoce/distribution_p_hat_1/eoce-p-hat-simulations-p95}
\end{center}
}{}

% 6 - distribution_p_hat_2
...
\begin{center}
\includegraphics[width=0.85\textwidth]{ch_inference_for_props/figures/eoce/distribution_p_hat_2/eoce-p-hat-simulations-p5}
\end{center}
}{}

% 7 - veg_coll_students_CLT_ahss

\eoce{\qt{Vegetarian college students\label{veg_coll_students_CLT_ahss}} Suppose that 8\% 
...
would be considered unusual.
\item The standard deviation of the sample proportion would be reduced by one-half if we increased the 
sample size from 125 to~250.
\end{parts}
 
}{}

% 8 - young_americans_CLT_1_ahss

\eoce{\qt{Young Americans, Part I\label{young_americans_CLT_1 _ahss}} About 77\% of 
