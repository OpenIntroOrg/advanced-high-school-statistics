...
\eoce{\qt{Make-up exam\label{makeup_exam}} \videohref{ahss_eoce_sol-makeup_exam}\ \ In a class of 25 students, 24 of them took an exam 
...
\includegraphics[width=0.95\textwidth]{ch_summarizing_data/figures/eoce/oscar_winners/oscars_winners_hist}}
\end{center}
\end{minipage}
