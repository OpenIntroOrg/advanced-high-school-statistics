...
\tabspecial{tableau-intensitymapsall}{\includegraphics[width=0.48\textwidth]{ch_summarizing_data/figures/eoce/county_commute_times/county_commute_times_map.pdf}}
\end{center}
\begin{parts}
...
% 24 - county_hispanic_latinx_pop

\eoce{\qt{Hispanic/Latinx population\label{county_hispanic_latinx_pop}} The US census collects 
