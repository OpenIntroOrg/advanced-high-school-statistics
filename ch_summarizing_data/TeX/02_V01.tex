...
\newline(2)  Add tick marks and scales to each.  Take note of the largest value in each data set.
\newline(3) Plot the dots as you would on an (x,y) coordinate plane.}
\end{tipBox}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.9\textwidth]{02/figures/emailCharactersDotPlot/emailCharactersDotPlotStackedRounded}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.8\textwidth]{02/figures/email50NumCharHist/email50NumCharHistWMeanMedian}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{02/figures/emailCharactersDotPlot/emailCharactersDotPlotStackedRoundedWithSD}
...
\begin{figure}
\centering
\includegraphics[width=0.65\textwidth]{02/figures/severalDiffDistWithSdOf1/severalDiffDistWithSdOf1}
...
\begin{figure}[ht]
   \centering
   \includegraphics[width=0.8\textwidth]{02/figures/email50NumCharHist/email50NumCharHist}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.85\mycaptionwidth]{02/figures/boxPlotLayoutNumVar/boxPlotLayoutNumVar}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{02/figures/TI83_box_plot_A/TI83_box_plot_A}
\end{center}
\end{example}
...
\begin{figure}[ht]
\centering
\includegraphics[width=\textwidth]{02/figures/emailCharactersDotPlot/email50NumCharDotPlotRobustEx}
...
\begin{figure}[h]
   \centering
   \includegraphics[width=0.9\textwidth]{02/figures/CToF_ConversionFigure/CToF_ConversionFigure}
...
\begin{figure}[bht]
   \centering
   \includegraphics[height=2.3in]{02/figures/emailNumberBarPlot/emailNumberBarPlot}
