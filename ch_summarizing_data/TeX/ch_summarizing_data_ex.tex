...
\begin{center}
\includegraphics[width = 60mm]{ch_summarizing_data/figures/eoce/mammals/mammals_lifeSpanGest}
\end{center}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.8\textwidth]{ch_summarizing_data/figures/eoce/associationPlots/associationPlots}
\end{minipage}
}{}
...
\hfill\includegraphics[width = 0.95\textwidth]{ch_summarizing_data/figures/eoce/country/country_infMort}
\end{minipage}
}{}
...
\begin{center}
\includegraphics[width = 0.64\textwidth]{ch_summarizing_data/figures/eoce/durhamAQI/durhamAQI_hist} 
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width = 0.7\textwidth]{ch_summarizing_data/figures/eoce/bimodalHistBox/bimodalHistBox}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.9\textwidth]{ch_summarizing_data/figures/eoce/marathon/marathon_histBox}
\end{center}
\begin{parts}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{ch_summarizing_data/figures/eoce/marathon/marathon_genderBox}
\end{center}
...
\end{parts}
\begin{center}
\includegraphics[width=0.95\textwidth]{ch_summarizing_data/figures/eoce/marathon/marathon_genderTimeSeries} \\
\end{center}
}{}
...
\begin{minipage}[c]{0.5\textwidth}
\begin{center}
\includegraphics[width = 60mm]{ch_summarizing_data/figures/eoce/acs/income_male_female}
\end{center}
\end{minipage}
}{}
...
\end{parts}
\begin{center}
\includegraphics[width = 120mm]{ch_summarizing_data/figures/eoce/apstats/apstats_box_hollow}
\end{center}
}{}
...
\item Annual salaries of the employees at a Fortune 500 company where only a few high level executives earn much higher salaries than the all other employees.
\end{parts}
}{}
