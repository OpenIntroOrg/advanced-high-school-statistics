...
\begin{figure}[bth]
   \centering
    \oiRedirect{tableau-histogramschoose}{\includegraphics[width=0.82\textwidth]{ch_summarizing_data/figures/email50NumCharHist/email50NumCharHist}}
...
\begin{figure}[h]
   \centering
     \oiRedirect{textbook-desmos-1varstats}{ \includegraphics[width=0.7\textwidth]{ch_summarizing_data/figures/email50Desmos/email50Desmos}}
...
\item \term{Box plots} do not show the \textit{distribution} of a data set in the way that histograms do.
