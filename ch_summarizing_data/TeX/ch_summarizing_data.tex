...
<<<<<<< HEAD
Sometimes questions such as the previous ones can be answered more easily with a \term{cumulative frequency histogram}. This type of histogram shows cumulative, or total, frequency achieved by each bin, rather than the frequency in that particular bin.
=======
...
\noindent Get started quickly with this Desmos \oiRedirect{desmos-normal}{Normal Calculator} (\small{available at \oiRedirect{openintro-ahss-desmos}{openintro.org/ahss/desmos}}).
...
\subsection*{Section summary}
\begin{itemize}
\item \termni{Categorical variables}, unlike numerical variables, are simply summarized by \termni{counts} (how many) and \termni{proportions}{proportion}.  These are referred to as frequency and relative frequency, respectively.
