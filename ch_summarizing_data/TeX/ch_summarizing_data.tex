...
\begin{figure}[h]
   \centering
     \oiRedirect{textbook-desmos-1varstats}{ \includegraphics[width=0.85\textwidth]{ch_summarizing_data/figures/email50Desmos/email50Desmos}}
\caption{Use \oiRedirect{textbook-desmos-1varstats}{this calculator} (\small{openintro.org/ahss/desmos}) to graph and find summary statistics for a single variable in Desmos, as shown in the figure.}
...
\begin{examplewrap}
\begin{nexample}{Enter the following 10 data points into a calculator or into this \oiRedirect{textbook-desmos-1varstatsdiscrete}{Desmos calculator} \mbox{(\small{openintro.org/ahss/desmos}):}
\begin{center}
