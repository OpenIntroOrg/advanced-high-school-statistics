...
\captionsetup{width=0.885\textwidth}

\begin{figure}[h]
   \centering
   \Figure   [A scatterplot is shown with "Number of Characters (in thousands)" along the horizontal axis (range from 0 to 70) and "Number of Lines" along the vertical axis (range from 0 to 1200). There is a strong, positive linear assocation between the two variables, with a higher concentration of dots for small values of both variables.]{0.8}{email50LinesCharacters}
...
\begin{figure}[h]
   \centering
  \Figure
    [A dot plot is shown for the variable ``Number of Characters (in thousands)". There is a horizontal axis ranging from about 0 to 70, and then several points are shown horizontally above the axis, scattered over the range. There is a higher density of points between 0 and 20, with a moderate density of points from 20 to 30, and then a few more observations at about 42, 43, and 63.]
{0.825}{emailCharactersDotPlot}{emailCharactersDotPlotStackedRounded}
...
\begin{figure}[bth]
   \centering
   \Figure  
    [A histogram with a horizontal axis of ``Number of Characters (in thousands)" and a vertical axis showing the frequency of occurrence of different bins of Number of Characters. The first bin is from 0-5 with a frequency (count) of 19 observations, 5-10 has a frequency of 12, 10-15 has 6, 15-20 has 2, 20-25 has 3, 25-30 has 5, and then the 40-45 and 60-65 bins each have a frequency of 1.]
{0.8}{email50NumCharHist}
...
\oiRedirect{tableau-histograms}{
   \Figures
    [A cumulative frequency histogram with a horizontal axis of ``Number of Characters (in thousands)" and a vertical axis showing the cumulative frequency up to including each bin. The first bin is from 0-5 with a cumulative frequency (count) of 19 observations, 5-10 has a cumulative frequency of 31, 10-15 has a cumulative frequency of 37.  Finally, bin 60-65 has a cumulative frequency of 50, which is the total count.]
{0.8}{email50NumCharHist}{email50NumCharCumulativeFreqHist}}
...
\begin{figure}[h]
   \centering
   \Figure [A histogram with a horizontal axis of ``Number of Characters (in thousands)" and a vertical axis showing the frequency of occurrence of different bins of Number of Characters is presented again, this time with median and mean labeled.  The first bin is from 0-5 with a frequency (count) of 19 observations, 5-10 has a frequency of 12, 10-15 has 6, 15-20 has 2, 20-25 has 3, 25-30 has 5, and then the 40-45 and 60-65 bins each have a frequency of 1.  The median is indicated with a yellow line at approximately 7 and the mean is indicated with a red line at approximately 11.  The graph is right skewed, with the mean greater than the median.]
{0.8}{email50NumCharHist}{email50NumCharHistWMeanMedian}
...
\centering
\Figures
    [A dot plot of 50 observations is shown with values ranging from about 0 to 65. Shading is shown to represent the regions within 1, 2, and 3 standard deviations. Only 1 point is not within the 3 standard deviations.]
...
\begin{nexample}{In the data's context (the number of characters in emails), describe the distribution of the \var{num\_\hspace{0.3mm}char} variable shown in the histogram below.
  \begin{center}
   \Figure[The histogram for ``Number of Characters (in thousands)" is presented again.  The horizontal axis has ``Number of Characters (in thousands)" and the vertical axis shows the frequency of occurrence of different bins of Number of Characters. The first bin is from 0-5 with a frequency (count) of 19 observations, 5-10 has a frequency of 12, 10-15 has 6, 15-20 has 2, 20-25 has 3, 25-30 has 5, and then the 40-45 and 60-65 bins each have a frequency of 1.]
{0.65}{email50NumCharHist}
  \end{center}}
...
\begin{figure}[h]
   \centering
 \Figure[A labeled, vertical box plot for the number of characters (in thousands) in 50 emails.  The range, in thousands, is from 0 to approximately 65.  In thousands, lower whisker is at 0, first quartile at 3, median at 7, third quartile at 16, upper whisker at 30, with three outliers shown as dots at 42, 43, and 65.]
{0.9}{boxPlotLayoutNumVar}{boxPlotLayoutNumVar}
...
\begin{center} 
\Figure[An image of a Desmos calculator showing some of the 1-variable statistics commands with histogram and box plot below the histogram.]
{0.95}{desmos1VarStats}
\end{center}
...
\Figure[A TI calculator image showing a box plot with min = 1, first quartile = 2, median = 5, third quartile = 14.5, and max = 19.  The box plot is slightly right skewed.]
{0.3}{TI83_box_plot_A}
}
...
\Figure [A screenshot from a Desmos calculator showing the summary statistics of the ``Number of Characters (in thousands) variable" on the left and, on the right, a histogram of the data with a box plot below it.  The graphs show that the data are right skewed.]
{.5}{email50Desmos}
}
...
\begin{figure}[ht]
\centering
 \Figure [Three dot plots are shown in the same plot. The largest observation from the original data set (discussed in previous dot plots) at about 64 thousand is removed in the second dot plan and is moved to 150 thousand in the third dot plot.]
{}{emailCharactersDotPlot}{email50NumCharDotPlotRobustEx}
...
\begin{figure}[h]
  \centering
  \Figure[A standard normal distribution is shown.  The mean is 0 and the standard deviation is 1.   The distribution is shaded to the left of the value 1.  Approximately 84\% of the graph is shaded. ]
{0.45}{satBelow1300}
...
\begin{center}
  \Figure[A normal distribution with a mean of 1100 and standard deviation of 200 has the area below the distribution shaded for horizontal values larger than 1300.]
{0.4}{satAbove1190}
\end{center}
...
\Figure{.35}{satBelow1030}{satAbove1030}}
...
\begin{center}
\Figure[A Desmos calculator screen.  On the left, it shows the commands mean, stdev, length and stats used on a small data set.  On the right is a histogram with a box plot below it of that data set.]
{0.95}{desmosNormal}
\end{center}
...
\Figure[A standard normal distribution shaded from the left up to a Z-score of 1.5.]
{0.4}{zscoreleftof1point5}\vspace{-2mm}
