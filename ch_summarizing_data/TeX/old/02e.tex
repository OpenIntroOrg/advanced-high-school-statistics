...
\hfill\includegraphics[width = 0.94\textwidth]{03/figures/eoce/images/roulette_wheel}
\end{minipage}
}{}
...
\eoce{\qt{Cat weights\label{catsBodyWeights}} The histogram shown \textPE{below} represents the weights (in kg) of 47 female and 97 male cats. \footfullcite{cats} \\
...
\begin{center}
\includegraphics[width=\textwidth]{03/figures/eoce/cats/cats_bodyWeight}
\end{center}
\end{minipage}
}{}
