...
\hfill\includegraphics[height=13mm]{02/figures/emailSpamNumberVenn/emailSpamNumberVenn} \vspace{-13mm}
\end{minipage}
}
\end{exercise}
...
\begin{figure}[hht]
\centering
\includegraphics[width=0.5\textwidth]{02/figures/complementOfD/complementOfD}
...
\begin{figure}[hht]
\centering
\includegraphics[width=0.6\textwidth]{02/figures/indepForRollingTwo1s/indepForRollingTwo1s}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.65\textwidth]{02/figures/drugUseVenn/drugUseVenn}
...
\Add{
\begin{example}{Are student and parent drug mutually exclusive?}
...
P(A | B) \neq P(A)
\end{align*}
which, by the first equation in the first Tip Box, implies that they are dependent.  If two events are mutually exclusive, knowing that the one occurred \emph{changes} the likelihood of the other to zero.  This is a strict form of dependence.  
}
...
\includegraphics[width=\textwidth]{02/figures/treeDiagramAndPass/treeDiagramAndPass} \vspace{-25mm}
\end{minipage}}
\end{exercise}
}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.9\textwidth]{02/figures/BreastCancerTreeDiagram/BreastCancerTreeDiagram}
...
\end{minipage}
\begin{minipage}[c]{0.5\linewidth}
\includegraphics[width=\textwidth]{02/figures/treeDiagramGarage/treeDiagramGarage}\vspace{-30mm}
\end{minipage}}
\end{exercise}
}
...
\begin{figure}
\centering
\includegraphics[width=0.73\textwidth]{02/figures/diceSumDist/diceSumDist}
...
\begin{figure}
\centering
\includegraphics[width=0.68\textwidth]{02/figures/usHouseholdIncomeDistBar/usHouseholdIncomeDistBar}
...
\begin{figure}
\centering
\includegraphics[width=0.72\textwidth]{02/figures/bookWts/bookWts}
...
\begin{figure}
\centering
\includegraphics[width=0.68\textwidth]{02/figures/contBalance/contBalance}
...
\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{02/figures/usHeightsHist180185/usHeightsHist180185}
...
\begin{figure}[tbh]
\centering
\includegraphics[width=0.9\textwidth]{02/figures/fdicHeightContDist/fdicHeightContDist}
...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{02/figures/fdicHeightContDistFilled/fdicHeightContDistFilled}
