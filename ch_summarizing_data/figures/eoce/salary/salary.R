...
histPlot(salSymm, xlim = c(60000, 70000), xlab = "(1)", ylim = c(0,12), col = oiB, axes = FALSE, ylab = "")
axis(1, at = seq(60000, 70000, 2500))
axis(2, at = seq(0,12,4))

histPlot(salSkew, xlab = "(2)", ylim = c(0,12), breaks = seq(0, 260000, by = 1000), col = oiB, axes = FALSE, xlim = c(60000,260000), ylab = "")
