...
\begin{examplewrap}
\begin{nexample}{Consider all 435 NBA players from the 2008-9 season presented in Figure~\ref{nbaNormal}.\footnotemark\,  Based on the graphs, are NBA player heights normally distributed? }
...
We see in Figure~\ref{oPositive40prop} that the distribution of number of people in sample with blood type O+ out of 40 is equivalent to the distribution of proportion of people in a sample of size 40 with blood type 0+, but with a change of scale.
