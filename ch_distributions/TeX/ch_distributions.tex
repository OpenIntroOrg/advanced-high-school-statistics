...
\\
\\
\Add{In Section \ref{diffofprops} and Section \ref{differenceOfTwoMeans} we apply Case 5 to find the mean and standard deviation for the difference of sample proportions and the difference of sample means.}