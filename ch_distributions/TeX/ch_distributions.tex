...
$\mu_X$ and $\mu_Y$, then if the mean of the difference of the
...
applications where we look at the difference in two sample
proportions ($\hat{p}_1 - \hat{p}_2$) or the difference in
