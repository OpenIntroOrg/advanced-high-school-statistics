...
\chapterintro{In this chapter, we consider sampling distributions for four common statistics:  sample proportion, sample mean, difference of sample proportions, and difference of sample means.  In each case, the goal is the same - to describe the center, spread, and shape of the sampling distribution and determine when normal approximation to the sampling distribution will be reasonable.   }
