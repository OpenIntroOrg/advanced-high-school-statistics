...
\Comment{D - Are the items below just for the TI-84 or also the TI-83?}

\begin{termBox}{\tBoxTitle{TI-84:  1. Finding areas under normal curve\vspace{0.5mm}}
...
\begin{termBox}{\tBoxTitle{TI-84:  2. Find a Z score that corresponds to a percentile}
...
\Comment{TODO(ddiez) - Swap out the poker example below.}
