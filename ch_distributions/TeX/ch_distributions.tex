...
We explore sampling distributions for two common statistics: sample proportion and sample mean.  We then consider the distributions of a difference of sample proportions and a difference of sample means.
...
\item Verify appropriate conditions and, if met, carry out normal approximation using a difference of sample proportions or a difference of sample means.  
...
\label{reviewdiffrv}
In Section~\ref{randomVariablesSection}, we saw how to find the mean and standard deviation of the difference of two random variables $X$ and $Y$.  We found that:
$$E(X - Y) = E(X) - E(Y)$$

\noindent and that when X and Y are \emph{independent}: 
...
%%%%%%%%%%Section exercises
%{\input{ch_distributions/TeX/sampling_distribution_of_a_difference.tex}}
