...
\begin{center}
\includegraphics[width=0.5\textwidth]{ch_distributions/figures/eoce/cltSimSYM/cltSimSYM_pop}
\end{center}
\begin{center}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{ch_distributions/figures/eoce/ipod/ipod_popdist}\textPE{\vspace{-2mm}}
\end{center}
\begin{parts}
