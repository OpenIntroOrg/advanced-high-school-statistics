...
plot(X, Y, type='l', axes = F, 
     xlim = c(-3.4,3.4), ylim = c(-0.11, 0.43), 
     ylab = "",yaxs="i")
...
par(mar = c(2,0,.3,0), las = 1, mgp = c(3,1,0), 
    cex.lab = 1.25, cex.axis = 0.9)

normTail(m = mean_v, s = sd_v, L = sophia_v, col = COL[1],yaxs="i")
...
normTail(m = mean_q, s = sd_q, L = sophia_q, col = COL[1],yaxs="i")
