...
collected data on a random sample of 170 married men in 
Britain, recording the age (in years) and heights (converted 
here to inches) of the men and their spouses.\footfullcite{Hand:1994} 
The scatterplot on the left shows the spouse's age plotted against the man's age, and the plot on the right shows spouse's height 
plotted against the man's height.
\newpage
\begin{center}
...
\end{center}
\begin{parts}
\item Describe the relationship between the ages of men in the sample and their spouses' ages.
\item Describe the relationship between the heights of men in the sample and their spouses' heights.
...
between heights of men in the sample and their spouses' heights?
\end{parts}
}{}
...
correlation between the ages of a set of men and their spouses if the set of men always married someone who was
\begin{parts}
