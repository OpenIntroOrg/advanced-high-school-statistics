...
\begin{center}
\includegraphics[width=0.35\textwidth]{ch_regr_simple_linear/figures/eoce/spouses_1_ap/husbands_wives_age} 
\hspace{5mm}
\includegraphics[width=0.35\textwidth]{ch_regr_simple_linear/figures/eoce/spouses_1_ap/husbands_wives_height}
\end{center}
\begin{parts}
