...
\eoce{\MarginVideo{ahss_eoce_sol-corr_husband_wife_age}\qt{Correlation, Part I} What would be the correlation between the ages of husbands and wives if men always married woman who were
\begin{parts}
...
\eoce{\MarginVideo{ahss_eoce_sol-murders_poverty_reg}\qt{Murders and poverty, Part I} \label{murderPoverty} The following regression output is for predicting annual murders per million from percentage living in poverty in a random sample of 20 metropolitan areas.\\[2mm]
