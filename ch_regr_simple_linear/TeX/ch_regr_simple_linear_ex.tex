...
\begin{center}
 \href{\oiRedirectUrl{tableau_starbucks_part_I}}{\includegraphics[width=0.32\textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/carb_cals_scat}}
...
\begin{minipage}[c]{0.4\textwidth}
\begin{center}
 \href{\oiRedirectUrl{tableau_starbucks_part_II}}{\includegraphics[width= \textwidth]{ch_regr_simple_linear/figures/eoce/starbucks/pro_cals} }\\
\end{center}
\end{minipage}
...
\end{minipage}
\begin{minipage}[c]{0.4\textwidth}
 \href{\oiRedirectUrl{tableau_urban_homeowners_part_I}}{\includegraphics[width=0.95\textwidth]{ch_regr_simple_linear/figures/eoce/urbanOwner/urbanOwner_withDC.pdf} }\vspace{-3mm}
\end{minipage}
}{}
...
\noindent\begin{minipage}[c]{0.4\textwidth}
 \href{\oiRedirectUrl{tableau_rate_my_professor}}{\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/prof/beauty_eval}} \\
\end{minipage}
\begin{minipage}[c]{0.6\textwidth}
\begin{tabular}{rrrrr}
  \hline
