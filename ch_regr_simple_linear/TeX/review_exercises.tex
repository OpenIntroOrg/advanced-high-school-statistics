...
\tabspecial{tableau-teaching-eval-beauty}{\includegraphics[width=\textwidth]{ch_regr_simple_linear/figures/eoce/rate_my_prof_ahss/rate_my_prof_eval_beauty.pdf}} \\
\end{minipage}
\begin{center}
