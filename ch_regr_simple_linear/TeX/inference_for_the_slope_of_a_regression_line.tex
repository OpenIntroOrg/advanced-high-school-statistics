...
% 38 - babies_head_gestation_inf_ahss

\eoce{\qt{Babies\label{babies_head_gestation_inf_ahss}} Is the gestational age 
...
The standard error for the coefficient of gestational age is 0.35.  Is there significance evidence that gestational age has a positive linear association with head circumference?  Use the Identify, Choose, Check, Calculate, Conclude framework and make sure to identify any assumptions used in the test. 
