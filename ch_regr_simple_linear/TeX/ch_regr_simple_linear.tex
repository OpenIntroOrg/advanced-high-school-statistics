...
\begin{center}
\includegraphics[width=0.90\textwidth]{ch_regr_simple_linear/figures/desmosLinReg/desmosLinRegCI}
\end{center}
...
\begin{center}
\includegraphics[width=0.95\textwidth]{ch_regr_simple_linear/figures/desmosLinReg/desmosLinRegTest}
\end{center}


\noindent \\ 
\\
Entering a lot of data into a calculator is not practical; we include calculator instructions here simply for the sake of completion. 
