...
%__________________
\section[Line fitting, residuals, and correlation]{Line fitting, residuals, and correlation \sectionvideohref{youtube-mPvtZhdPBhQ&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM} \sectionslideshref{gdoc_aps_slides_8-1}}
...
%__________________
\section[Fitting a line by least squares regression]{Fitting a line by least squares regression \sectionvideohref{youtube-z8DmwG2G4Qc&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM} \sectionslideshref{gdoc_aps_slides_8-2}}
...
%__________________
\section[Types of outliers in linear regression]{Types of outliers in linear regression \sectionvideohref{youtube-jZEKAlo1E54&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM} \sectionslideshref{gdoc_aps_slides_8-3}}
...
%__________________
\section[Inference for the slope of a regression line]{Inference for the slope of a regression line \sectionvideohref{youtube-depiT-hTaGA&list=PLkIselvEzpM63ikRfN41DNIhSgzboELOM} \sectionslideshref{gdoc_aps_slides_8-4}}
...
\begin{itemize}
\item[] \term{$t$-test for slope of regression line} 
\end{itemize}
 \inferencestep{Check}\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
\item[] 1.  Data come from a random sample or randomized experiment.
\item[] 2.  The residual plot shows no pattern implying that a linear model is 
\item[] \quad \ reasonable.\footnote{Technically, the residuals should be independent, nearly normal, and have constant standard deviation.}
\end{itemize}
...
\inferencestep{Identify} \vspace{-1mm}
\begin{itemize} 
\item[] the parameter, e.g. the true slope of the regression line relating air quality index to average rainfall per year for each city in the United States, and the confidence level, C\%, to be used.
\end{itemize}
\inferencestep{Choose} \vspace{-1mm}
\begin{itemize}
\item[] \term{$t$-interval for slope of regression line} 
\end{itemize}
\inferencestep{Check}\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
