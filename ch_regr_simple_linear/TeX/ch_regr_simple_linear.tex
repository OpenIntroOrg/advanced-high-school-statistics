...
%%
\subsection[Calculator: the linear regression $t$-interval for the slope]{Calculator: the linear regression \pmb{$t$}-interval for the slope}
...
%%
\subsection[Calculator: the linear regression $t$-test for the slope]{Calculator: the linear regression \pmb{$t$}-test for the slope}
