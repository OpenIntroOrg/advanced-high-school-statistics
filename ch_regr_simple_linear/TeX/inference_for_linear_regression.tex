...
scatterplot below summarizes mens' heights and their spouses' heights in a random 
...
spouse's height from husband's height is also provided in the table.
...
\end{minipage}
\begin{parts}
\item Is there strong evidence that taller men have taller spouses? 
