\chapter{Multiple and logistic regression (special topic)}
...
\begin{figure}
\centering
\includegraphics[width=\textwidth]{08/figures/logitTransformationFigureHoriz/logitTransformationFigureHoriz}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.95\textwidth]{08/figures/logisticModel/logisticModelPredict}
