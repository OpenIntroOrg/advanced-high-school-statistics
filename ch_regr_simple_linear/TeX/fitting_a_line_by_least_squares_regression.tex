...
calorie content.
\begin{center}
\href{\oiRedirectUrl{tableau-starbucks-p1}}{
...
}\tableauhref{tableau-starbucks-p1}
\end{center}
\begin{parts}
...
\eoce{\qt{The Coast Starlight, Part II\label{coast_starlight_reg}} \videohref{ahss_eoce_sol-coast_starlight_reg}\ \  
...
\eoce{\qt{Murders and poverty, Part I\label{murders_poverty_reg}} \videohref{ahss_eoce_sol-murders_poverty_reg}\ \ The following 
