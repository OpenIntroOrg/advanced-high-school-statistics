...
\begin{itemize}\vspace{-1mm}
\setlength{\itemsep}{0mm}
\item[] 1-sample $t$-test with paired data \hfill page~\pageref{matchedpairsttest}
\item[] 1-sample  $t$-interval with paired data  \hfill page~\pageref{matchedpairstint}
\end{itemize}
...
\begin{itemize}\vspace{-1mm}
\setlength{\itemsep}{0mm}
\item[] $t$-interval for the slope \hfill see Graphing Calculator Guides at \oiRedirect{ahss}{openintro.org/ahss}
\item[] $t$-test for the slope  \hfill see Graphing Calculator Guides at \oiRedirect{ahss}{openintro.org/ahss}
\end{itemize}
