...
\newcommand{\oiRedirectUrl}[1]{http://www.openintro.org/redirect.php?go=#1&referrer=ahss4_pdf}
...
\makeatother
% 8.3 Caption Width
\newcommand{\mycaptionwidth}{0.825\textwidth}
