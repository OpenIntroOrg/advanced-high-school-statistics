...
\newenvironment{calctext}[1]{\texttt{#1}}{}
\newenvironment{calctextmath}[1]{\mathtt{#1}}{}
\newenvironment{calcbutton}[1]{\texttt{#1}}{}
% 6.4 Highlighting
...
\newcommand{\videohref}[2][5mm]{\href{#2}{\raisebox{-0.5ex}[0pt]{\includegraphics[height=#1]{extraTeX/icons/video_camera}}}}
\newcommand{\videohrefpadded}[2][5mm]{\hspace{3mm}\videohref{#2}}
