...
\newenvironment{learningobj}[1]{{\color{oiB}\normalfont\large \bfseries\fontfamily{phv} \selectfont{#1}}}{}
...
\newcommand{\oiRedirectUrl}[1]{http://www.openintro.org/redirect.php?go=#1&referrer=ahss_pdf}
%\newcommand{\oiRedirect}[2]{\href{\oiRedirectUrl{#1}}{#2}}
\newcommand{\oiRedirect}[2]{\lowercase{\href{\oiRedirectUrl{#1}}}{#2}}
\newcommand{\videohref}[2][4.5mm]{\oiRedirect{#2}{\raisebox{-0.3mm}[0pt]{\includegraphics[height=#1]{extraTeX/icons/video_camera}}}}
\newcommand{\tableauhref}[2][4.5mm]{\oiRedirect{#2}{\raisebox{-0.3mm}[0pt]{\includegraphics[height=#1]{extraTeX/icons/tableau}}}}
...
\textbf{\color{oiR}\small\fontfamily{phv}%
