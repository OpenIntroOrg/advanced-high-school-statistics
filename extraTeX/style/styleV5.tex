...
\newcommand\Add[1]{\marginpar[\color{oiR}{\Huge$\bullet$}]{\color{oiR}{\Huge$\bullet$}}{\color{oiB}#1}}
\newcommand\Cut[1]{\marginpar[\color{oiR}{\Huge$\bullet$}]{\color{oiR}{\Huge$\bullet$}}{\color{oiGC}#1}}
\newcommand\Comment[1]{\marginpar[\color{oiR}{\Huge$\bullet$}]{\color{oiR}{\Huge$\bullet$}} {\color{oiG}{[#1]}}}
\newcommand{\CommentA}[1]{\Comment{#1}}
\newcommand{\note}[1]{\Comment{#1}}
