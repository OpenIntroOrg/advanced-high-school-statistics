...
\item \oiRedirect{ahss2-online-temp}{Online, interactive version of textbook}\footnote{Developed by Emiliano Vega and Ralf Youtz of Portland Community College using MathJax.}
\item Complete companion course with the LMS \oiRedirect{ahss_mom}{{MyOpenMath}}\footnote{\oiRedirect{myopenmath-ahss}{www.myopenmath.com/course/public.php?cid=11774}}
