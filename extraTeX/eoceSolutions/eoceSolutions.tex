...
\includegraphics[width = 0.375\textwidth]{ch_summarizing_data/figures/eoce/acs/income_age}\\
(b) \\
\includegraphics[width = 0.375\textwidth]{ch_summarizing_data/figures/eoce/acs/income_age_male}\\
\includegraphics[width = 0.375\textwidth]{ch_summarizing_data/figures/eoce/acs/income_age_female}\\
...
Legend: 1 | 0 = 10\%} \\
(b) \\
\includegraphics[width = 0.43\textwidth]{ch_summarizing_data/figures/eoce/fiber_cereal/cereal_fiber_dot} \\
(c) \\
\includegraphics[width = 0.37\textwidth]{ch_summarizing_data/figures/eoce/fiber_cereal/cereal_fiber_hist} \\
\includegraphics[width = 0.37\textwidth]{ch_summarizing_data/figures/eoce/fiber_cereal/cereal_fiber_relhist} \\
...
% 29 - overweight_baggage

\eocesol{$Z = 1.56$, $P(Z > 1.56) = 0.0594$, i.e. 6\%.}

% 31 - overweight_baggage_2
