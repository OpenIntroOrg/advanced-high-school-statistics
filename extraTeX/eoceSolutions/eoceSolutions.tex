...
% 31 - patreon_contributions_prob_dist
...
(b)~Since the success-failure condition is met the sampling distribution for $\hat{p} \sim N(\mu = 0.08, \sigma = 0.0192)$. $P(\hat{p} < 0.06) = P(Z < -1.04) = 0.1492$.
...
(c)~True. The 95\% confidence interval is given by: (42.6\%, 47.4\%), and we can see that 50\% is outside of this interval. This 
