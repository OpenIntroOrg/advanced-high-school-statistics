...
\begin{center}
\includegraphics[width=0.48\textwidth]{03/figures/eoce/tree/tree_boxPlot}
\end{center}
...
\begin{center}
\includegraphics[width=0.45\textwidth]{03/figures/eoce/tree/tree_swazilandHIV}
\end{center}
...
\begin{center}
\includegraphics[width=0.48\textwidth]{03/figures/eoce/tree/tree_lupus}
\end{center}
...
(c)~58.86\%.
(d)~4.56\%. \\
\includegraphics[width=0.23\textwidth]{04/figures/eoce/z/zltNeg}
\includegraphics[width=0.23\textwidth]{04/figures/eoce/z/zgtPos}
\includegraphics[width=0.23\textwidth]{04/figures/eoce/z/zBet}
\includegraphics[width=0.23\textwidth]{04/figures/eoce/z/zgtAbs}}

% 3
\eocesol{(a)~Verbal: $N(\mu = 462, \sigma = 119)$, Quant: $N(\mu = 584, \sigma = 151)$.
(b)~$Z_{VR} = 1.33$, $Z_{QR} = 0.57$. \\
\includegraphics[width=0.3\textwidth]{04/figures/eoce/gre/gre} \\
...
(b)~Two different answers are reasonable. $^{Option~1}$Since the population distribution is only slightly skewed to the right, even a small sample size will yield a nearly normal sampling distribution. We also know that the songs are sampled randomly and the sample size is less than 10\% of the population, so the length of one song in the sample is independent of another.  We are looking for the probability that the total length of 15 songs is more than 60 minutes, which means that the average song should last at least $60/15 = 4$ minutes. Using $SD_{\bar{x}}=1.62/\sqrt{15}$, $Z=1.31$ $\to$ 0.0951. $^{Option~2}$Since the population distribution is not normal, a small sample size may not be sufficient to yield a nearly normal sampling distribution. Therefore, we cannot estimate the probability using the tools we have learned so far.
