...
Legend: 1 | 0 = 10\%} \\
(b) \\
\includegraphics[width = 0.43\textwidth]{ch_one_variable_data_collecting_data/figures/eoce/fiber_cereal/cereal_fiber_dot} \\
(c) \\
\includegraphics[width = 0.37\textwidth]{ch_one_variable_data_collecting_data/figures/eoce/fiber_cereal/cereal_fiber_hist} \\
\includegraphics[width = 0.37\textwidth]{ch_one_variable_data_collecting_data/figures/eoce/fiber_cereal/cereal_fiber_relhist} \\
...
\includegraphics[width = 0.375\textwidth]{ch_regression_analysis/figures/eoce/acs_ahss/income_age}\\
(b) \\
\includegraphics[width = 0.375\textwidth]{ch_regression_analysis/figures/eoce/acs_ahss/income_age_male}\\
\includegraphics[width = 0.375\textwidth]{ch_regression_analysis/figures/eoce/acs_ahss/income_age_female}\\
