\section[$t$-Distribution Critical Values Table]{$\pmb{t}$-Distribution Critical Values Table}
...
%  \begin{center}
%  \includegraphics[width=0.3\textwidth]{ch_inference_for_means/figures/tDistDF18LeftTail2Point10/tDistDF18LeftTail2Point10}
%  \end{center}
