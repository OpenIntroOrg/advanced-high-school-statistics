...
\item[\ref{dataBasics}]
    \datawrap{\datalink{loan50}, \datalink{loans\_full\_schema}}
...
\item[\ref{conditionalProbabilitySection}]
    ...
    Simulated data set based on real population summaries at \\
...
\item[\ref{oneSampleMeansWithTDistribution}]
  ...
  \emph{High mercury levels in hair samples from
    ...
    and we assume these 19 dolphins reasonably represent a simple
...
\item[\ref{pairedData}]
    \datawrap{\datalink{textbooks}, \datalink{ucla\_textbooks\_f18}}
