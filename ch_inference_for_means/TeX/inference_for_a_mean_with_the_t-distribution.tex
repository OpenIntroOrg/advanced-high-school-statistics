...
\eoce{\qt{Identify the critical $t$\label{identify_critical_t}} \videosolution{ahss_eoce_sol-identify_critical_t} An independent random 
...
\eoce{\qt{Play the piano\label{play_piano}} \videosolution{ahss_eoce_sol-play_piano} Georgianna claims that in a small city 
