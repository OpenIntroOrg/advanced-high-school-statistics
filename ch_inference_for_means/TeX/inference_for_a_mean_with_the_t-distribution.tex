...
\eoce{\qt{Identify the critical $t$\label{identify_critical_t}} \videosolution{ahss_eoce_sol-identify_critical_t} A random 
...
\begin{parts}
\item Evaluate Georgianna's claim using a hypothesis test and include all steps of the Identify, Choose, Check, Calculate, Conclude framework.
\item Construct a 95\% confidence interval for the number of years students in 
this city take piano lessons and include all steps of the Identify, Choose, Check, Calculate, Conclude framework.
...
\eoce{\qt{Car insurance savings\label{car_insurance_savings}} \videosolution{ahss_eoce_sol-car_insurance_savings} 
