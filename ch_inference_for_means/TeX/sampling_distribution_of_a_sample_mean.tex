...
\begin{center}
\includegraphics[width=\textwidth]{ch_inference_for_means/figures/eoce/ages_pennies_1/penniesAges_pop} 
\end{center}
\end{minipage}\vspace{-1mm}
\begin{center}
\includegraphics[width=0.325\textwidth]{ch_inference_for_means/figures/eoce/ages_pennies_1/penniesAges_n5} 
\includegraphics[width= 0.325\textwidth]{ch_inference_for_means/figures/eoce/ages_pennies_1/penniesAges_n30} 
\includegraphics[width= 0.325\textwidth]{ch_inference_for_means/figures/eoce/ages_pennies_1/penniesAges_n100} 
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.55\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_symm_pop/identify_dist_symm_pop.pdf} \\
\includegraphics[width=0.325\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_symm_pop/identify_dist_symm_sampling_n5.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_symm_pop/identify_dist_symm_samp.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_symm_pop/identify_dist_symm_sampling_n25.pdf}
\end{center}
}{}

% 6 - identify_dist_ls_pop
...
\begin{center}
\includegraphics[width=0.55\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_ls_pop/identify_dist_ls_pop.pdf}
\end{center}
\begin{center}
\includegraphics[width=0.325\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_ls_pop/identify_dist_ls_sampling_n81.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_ls_pop/identify_dist_ls_samp.pdf}
\includegraphics[width=0.325\textwidth]{ch_inference_for_means/figures/eoce/identify_dist_ls_pop/identify_dist_ls_sampling_n18.pdf}
\end{center}
}{}
...
\begin{center}
\includegraphics[width=0.5\textwidth]{ch_inference_for_means/figures/eoce/songs_on_ipod/songs_on_ipod_pop_hist.pdf}
\end{center}
\begin{parts}
...
\eoce{\qt{Spray paint\label{spray_paint_ap}} Suppose the area that can be painted using a 
...
% 12 - betting_on_dinner_ap

\eoce{\qt{Betting on dinner\label{betting_on_dinner_ap}} A restaurant is having a promotion where prices of menu items are determined randomly following some underlying distribution. We are told that the price of basket of fries is drawn from a normal distribution with mean 6 and standard deviation of 2. You want to get 5 baskets of fries but you only have \$28 in your pocket. What is the probability that you would have enough money to pay for all five baskets of fries?
}{}
