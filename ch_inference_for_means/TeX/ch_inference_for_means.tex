...
\end{itemize}
\item Interpret the interval:  ``We are C\% confident that the true \emph{mean} of [...] is between \underline{\ \ \ \ \ } and \underline{\ \ \ \ \ }."
...
\end{itemize}
\item Evaluate the CI and write in the form (\underline{\ \ \ \ \ }, \underline{\ \ \ \ \ }).
\item Interpret the interval: ``We are C\% confident that the true \emph{mean of the differences} in [...] is between \underline{\ \ \ \ \ } and \underline{\ \ \ \ \ }."
\item State the conclusion to the original question.
\end{enumerate}}
\end{termBox}
...
\end{itemize}
\item Evaluate the CI and write in the form (\underline{\ \ \ \ \ }, \underline{\ \ \ \ \ }).
\item Interpret the interval:  ``We are C\% confident that the true \emph{difference in mean} [...] is between \underline{\ \ \ \ \ } and \underline{\ \ \ \ \ }."
\item State the conclusion to the original question.
\end{enumerate}}
\end{termBox}
