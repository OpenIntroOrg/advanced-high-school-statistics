...
\begin{itemize}
\item[] To estimate a single mean we use a \term{1-sample $t$-interval}.
\end{itemize}
...
\begin{itemize}
\item[] To carry out a test for a single mean we use a \term{1-sample \pmb{$t$}-test}.
\end{itemize}
 \inferencestep{Check} Check conditions for the sampling distribution of $\bar{x}$ to be nearly normal.\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\inferencestep{Choose} Choose the appropriate test procedure and identify it by name.  \vspace{-1mm}
\begin{itemize}
\item[] To carry out a test for the mean of paired differences we use a \term{matched pairs  $t$-test}.
\end{itemize}
...
\item[\inferencestep{Check}] We have a random sample of students and have paired data on them.  We will assume that this sample of size 30 represents less than 10\% of the total population of such students.  Finally, the number of differences is $n_{\text{\emph{diff}}}=30\ge 30$, so we can proceed with the matched pairs $t$-test.  
...
\inferencestep{Choose} Choose the appropriate interval procedure and identify it by name. \vspace{-1mm}
\begin{itemize}
\item[] To estimate the mean of paired differences we use a \term{matched pairs $t$-interval}.
\end{itemize}
\inferencestep{Check} Check conditions for the sampling distribution of $\bar{x}_{\text{\emph{diff}}}$ to be nearly normal.\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\item[\inferencestep{Check}] We have a random sample of students with paired observations on them.  We will assume that these 30 students represent less than 10\% of the total number of such students.  Finally, the number of differences is $n_{\text{\emph{diff}}}=30\ge 30$, so we can proceed with the matched pairs $t$-interval.  
...
\item The matched pairs $t$-interval and $t$-test require the sampling distribution of $\bar{x}_{\text{\emph{diff}}}$ to be nearly normal.  For this reason, we must check that the following conditions are met.
\begin{itemize}
...
\end{itemize}
 \inferencestep{Choose} Choose the appropriate interval procedure and identify it by name.  \vspace{-1mm}
\begin{itemize}
\item[] To estimate the difference of means we use a \term{2-sample $t$-interval}.
\end{itemize}
...
\end{itemize}
 \inferencestep{Choose} Choose the appropriate test procedure and identify it by name. \vspace{-1mm}
\begin{itemize}
\item[] To carry out a test for the difference of means we use a \term{2-sample $t$-test}.
\end{itemize}
 \inferencestep{Check} Check conditions for the sampling distribution of $\bar{x}_1-\bar{x}_2$ to be nearly normal.\vspace{-1mm}
\begin{itemize}
\setlength{\itemsep}{0mm}
...
\item Test $H_0$: $\mu_1-\mu_2=0$ at the $\alpha$ significance level using a \term{2-sample t-test}.
\end{itemize}
