...
\begin{figure}[h]
\centering
\includegraphics[width=0.55\textwidth]{ch_inference_for_means/figures/tDistCompareToNormalDist/tDistCompareToNormalDist}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.72\textwidth]{ch_inference_for_means/figures/tDistConvergeToNormalDist/tDistConvergeToNormalDist}
...
\begin{nexample}{An SAT preparation company claims that its students' scores
    ...
    Use the five step framework to organize your work.
    \begin{center}
    \includegraphics[width=0.38\textwidth]{ch_inference_for_means/figures/satImprovementHTDataHistogram/satImprovementHTDataHistogram}
