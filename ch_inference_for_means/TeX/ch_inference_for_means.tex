...
%%
\subsection[Calculator: the 1-sample $t$-test with paired data]{Calculator: the 1-sample \pmb{$t$}-test with paired data}
...
\subsection[Calculator: the 1-sample $t$-interval with paired data]{Calculator: the 1-sample \pmb{$t$}-interval with paired data}
