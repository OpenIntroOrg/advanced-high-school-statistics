...
%__________________
\section[Inference for a single mean with the $t$-distribution]{Inference for a single mean with the $t$-distribution \sectionvideohref{coursera_video-t_distribution} \sectionvideohref{coursera_video-inf_for_mean}}
...
%__________________
\section[Inference for paired data]{Inference for paired data \sectionvideohref{coursera_video-inf_paired_means}}
...
%__________________
\section[Difference of two means using the $t$-distribution]{Difference of two means using the $t$-distribution \sectionvideohref{coursera_video-inf_two_means}}
