...
$$t = \frac{\bar{x}_{\text{\emph{diff}}} - 0}{SE_{\bar{x}_{\text{\emph{diff}}}_{\text{\emph{diff}}}}} = \frac{12.76 - 0}{1.67} = 7.65  \quad \quad \quad df=72$$
...
\begin{itemize}
\setlength{\itemsep}{0mm}
\item H$_0: \mu_{\text{\emph{diff}}}=0$
\item H$_0: \mu_{\text{\emph{diff}}} \ne \text{or} < \text{or} > 0$
\end{itemize}
\item Identify the significance level $\alpha$.
