...
myPDF("emailSpamNumberSegBar.pdf", 4.05, 2.5, mar=c(2, 3, 0.5, 0.5), mgp=c(2.2, 0.6, 0))
...
myPDF("emailSpamNumberSegBarSta.pdf", 4.05, 2.5, mar=c(2, 2.5, 0.5, 0.5), mgp=c(2.2, 0.6, 0))
