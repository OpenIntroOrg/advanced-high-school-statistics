...
\eoce{\qt{Area under the curve, I} What percent of a standard normal distribution ($\mu = 0$, $\sigma = 1$) is found in each region? Also, draw a graph for each part.\vspace{-3mm}
\begin{multicols}{4}
\begin{parts}
\item $Z < -1.35$
\item $Z > 1.48$
...
\eoce{\qt{Area under the curve, II} What percent of a standard normal distribution (mean of 0, standard deviation of 1) is found in each region? Also, draw a graph for each part.\vspace{-3mm}
\begin{multicols}{4}
\begin{parts}
\item $Z > -1.13$
\item $Z < 0.18$
...
\eoce{\qt{GRE scores, Part II} In Exercise~\ref{GRE} we saw two distributions for GRE scores was nearly normal with $\mu=462$ and $\sigma=119$ for the verbal part of the exam, and it was nearly normal with $\mu=584$ and $\sigma=151$ for the quantitative part. Use this information to compute each of the following:
\begin{parts}
...
\eoce{\qt{Triathlon times, Part II} In Exercise~\ref{triathlon} we saw two distributions for triathlon times was nearly normal with $\mu=4313$ and $\sigma=583$ for \emph{Men, Ages 30 - 34}, and it was nearly normal with $\mu=5261$ and $\sigma=807$ for the \emph{Women, Ages 25 - 29} group. Times are listed in seconds. Use this information to compute each of the following:
\begin{parts}
...
\begin{center}
\includegraphics[width=0.46\textwidth]{04/figures/eoce/scores/scores_hist}\ \ \ \ 
\includegraphics[width= 0.46\textwidth]{04/figures/eoce/scores/scores_qq}
\end{center}
}{}
...
\begin{center}
\includegraphics[width= 0.46\textwidth]{04/figures/eoce/heightsFcoll/heightsFcoll_hist}\ \ \ \ 
\includegraphics[width= 0.46\textwidth]{04/figures/eoce/heightsFcoll/heightsFcoll_qq}
\end{center}
}{}
...
\includegraphics[width=0.85\textwidth]{04/figures/eoce/images/dreidelSm}
\end{minipage}
}{}
...
\subsection{Distribution of a sample proportion}

\textPE{Exercises for this section are coming in the Preliminary Edition. We may also provide exercises online in mid-to-late Fall 2014.}

%\Comment{cut problems on ``more discrete distributions"}