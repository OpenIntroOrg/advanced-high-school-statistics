...
\item The \textbf{binomial formula} for finding the probability of exactly $x$ successes in $n$ independent trials.
...
\begin{itemize}
\item For a \term{discrete probability distribution}, the \textbf{sum} of the probabilities must equal 1.  For a \term{continuous probability distribution}, the \textbf{area under the curve} represents a probability and the total area under the curve must equal~1.
