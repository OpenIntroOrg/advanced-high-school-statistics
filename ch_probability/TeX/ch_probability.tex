...
\begin{center}
\oiRedirect{desmos-geometric}{\includegraphics[width=0.95\textwidth]{ch_probability/figures/desmosGeometric/desmosGeometric}}
\end{center}
...
%%%%%%%
\Comment{added without replacement consideration}
...
\begin{center}
\oiRedirect{desmos-binomial}{\includegraphics[width=0.95\textwidth]{ch_probability/figures/desmosBinomial/desmosBinomial}}
\end{center}
