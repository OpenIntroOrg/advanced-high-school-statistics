...
\Comment{I edited this a little so that it would be parallel to the discussion on independence}

\Comment{D: What is ``this''?}
...
\Comment{changed independence, to independent to refer to types of events}

\Comment{D: I'm not sure what this means or where the change is that is being referred to.}
...
Bayes' Theorem is just a generalization of what we have done using tree diagrams. The formula \Add{need not} be memorized; \Add{it can always be derived using a tree diagram:} \Comment{Was there any text cut, or was this sentence really messed up before?}
\begin{itemize}
\setlength{\itemsep}{0mm}
