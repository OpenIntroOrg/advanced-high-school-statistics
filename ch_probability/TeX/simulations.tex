...
\eoce{	\qt{Smog check, Part II \label{smog_check_2}} Consider the fleet of seven cars in Exercise ~\ref{smog_check_1}.  Remember that 16\% of cars fail pollution tests (smog checks) in California, and that we assume each car is independent.
\begin{parts}
