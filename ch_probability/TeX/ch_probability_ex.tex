...
\eoce{\qt{Four games, one winner} Below are four versions of the same game. Your archnemesis gets to pick the version of the game, and then you get to choose how many times to flip a coin: 10 times or 100 times. Identify how many coin flips you should choose for each version of the game. It costs \$1 to play each game. Explain your reasoning.
\begin{parts}
...
\eoce{\qt{Underage drinking, Part I} \label{alcohol} The Substance Abuse and Mental Health Services Administration estimated that 70\% of 18-20 year olds consumed alcoholic beverages in 2008.\footfullcite{webpage:alcohol}
\begin{parts}
