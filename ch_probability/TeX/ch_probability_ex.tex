...
%\Comment{33 and 34  are 53 and 54 from original binomial distr section.  35 and 36 are 42 and 41 from bin distr section.  Unfortunately the part I and part II have been separated for 36 and 37.  }
%\Comment{incorportated the questions on sampling from a small population into the corresponding chapter (used to be its own section)}
...
%\Comment{the solution to this prob doesn't seem to match question}
