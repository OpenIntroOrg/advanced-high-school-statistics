...
\eoce{\qt{Dice rolls} If you roll a pair of fair dice, what is the probability of \textPE{\vspace{-3mm}}
\begin{multicols}{3}
\begin{parts}
...
\eoce{\qt{Health and health coverage, Part II\label{healthCovHealth}} introduced a contingency table summarizing the relationship between health status and health coverage for a sample of 20,000 Americans. In the table below, the counts have been replaced by relative frequencies (probability estimates).
